...
import 'package:remood/app/package/classes/event.dart';
import 'package:remood/app/package/classes/event_list.dart';
import 'package:remood/app/package/src/calendar_header.dart';
import 'package:remood/app/package/src/default_styles.dart';
import 'package:remood/app/package/src/weekday_row.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart' show DateFormat;

import 'classes/multiple_marked_dates.dart';

export 'package:remood/app/package/classes/event_list.dart';
              ...
              child: GridView.count(
                ...
                children: List.generate(totalItemCount,
                  ...
                  if (DateTime.now().month == month &&
                      DateTime.now().year == year) {
                    isPrevDay = DateTime.now().day > index + 1 - _startWeekday;
