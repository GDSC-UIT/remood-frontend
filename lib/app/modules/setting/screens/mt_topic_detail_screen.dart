        ...
        child: Column(
          children: [
            ...
            Container(
              width: screenWidth,
              padding:
                  const EdgeInsets.only(right: 35, left: 25, top: 8, bottom: 8),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: CustomTextStyle.normalText(
                            Color(controller.currentTopic.value.icon.TopicColor)
                                .withOpacity(1),
                          ),
                        ),
                        const SizedBox(
                  ...
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        // Value
                        Container(
                          margin: EdgeInsets.only(right: screenWidth * 0.0267),
