...
class NegativeDiaryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => (readNegativeDiary.negativeDiaryList.isNotEmpty)
          ? ListView.separated(
                ...
                return GestureDetector(
                  onTap: () {
                    readNegativeDiary.readDiary(
                        ...
                        index,
                        "Negative diary",
                        readNegativeDiary.negativeDiaryList[index],
                        1);
                  },
                  child: Slidable(
                    endActionPane:
                      ...
                      SlidableAction(
                        onPressed: ((context) {
                          readNegativeDiary.deletePinnedDiary(index,
                              readNegativeDiary.negativeDiaryList[index]);
                    ...
                    child: DiaryCard(
                        diary: readNegativeDiary.negativeDiaryList[index]),
                  ),
                );
              }),
